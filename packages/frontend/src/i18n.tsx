...
export const TEXT = {
  de: {
    ...
    heroCopy:
      'Alle Filme und Serien, die im gewählten Monat neu zu Netflix, Disney+, Prime Video, Apple TV und RTL+ dazugekommen sind – für Deutschland.',
    ...
    disclaimer:
      'Inoffizielles Projekt. Netflix, Disney+, Prime Video, Apple TV und RTL+ sowie alle Titel und Marken sind Eigentum ihrer jeweiligen Rechteinhaber.',
  },
  en: {
    light: 'Light',
    dark: 'Dark',
    ...
    heroCopy:
      'Every film and series added to Netflix, Disney+, Prime Video, Apple TV and RTL+ in the selected month – for Germany.',
    ...
    disclaimer:
      'Unofficial project. Netflix, Disney+, Prime Video, Apple TV and RTL+ as well as all titles and trademarks belong to their respective owners.',
  },
} as const;
